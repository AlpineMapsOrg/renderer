...
class TestSimplisticTileScheduler: public QObject
{
  Q_OBJECT
private:
...
private slots:
  ...
  void emitsLoadedTiles() {
    connect(m_scheduler.get(), &TileScheduler::tileRequested, this, &TestSimplisticTileScheduler::giveTiles);
    connect(this, &TestSimplisticTileScheduler::orthoTileReady, m_scheduler.get(), &TileScheduler::loadOrthoTile);
    connect(this, &TestSimplisticTileScheduler::heightTileReady, m_scheduler.get(), &TileScheduler::loadHeightTile);
