...
void gl_engine::AvalancheReportManager::receive_report_from_server(tl::expected<std::vector<nucleus::avalanche::ReportTUWien>, QString> data_from_server)
{
    ...
    std::fill(m_ubo_eaws_reports->data.reports, m_ubo_eaws_reports->data.reports + 1000, glm::ivec4(-2, 0, 0, 0));
    ...
    /*
        ...
        std::fill(m_ubo_eaws_reports->data.reports, m_ubo_eaws_reports->data.reports + 1000, glm::ivec4(-3, 0, 0, 0));
        m_ubo_eaws_reports->update_gpu_data();
        return;
        */
}
