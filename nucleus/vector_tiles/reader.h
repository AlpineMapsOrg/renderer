...
struct EawsRegion
{
    ...
    std::vector<glm::vec2> verticesInGlobalCoordinates; // the vertices of the region's bounding polygon
};
...
namespace vector_tile
{
    namespace reader
    {
         ...
         */
        tl::expected<std::vector<EawsRegion>, std::string> eaws_regions(
            const QByteArray& inputData, const std::string& nameOfLayerWithEawsRegions = "micro-regions");
    }
}
#endif // READER_H
