...
public:
    ...
    explicit OldScheduler(QObject* parent = nullptr);
    // Seconds constructor still here for tests, Is it necessary?
    explicit OldScheduler(const QByteArray& default_ortho_tile, const QByteArray& default_height_tile, QObject* parent = nullptr);
    ~OldScheduler() override;
