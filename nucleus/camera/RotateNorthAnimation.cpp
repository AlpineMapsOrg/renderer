...
void RotateNorthAnimation::reset_interaction(Definition camera, AbstractDepthTester* depth_tester)
{
...
std::optional<glm::vec2> RotateNorthAnimation::get_operation_centre(){
