...
public slots:
    void run(webgpu_compute::GraphRunContext context);
...
private:
    ...
    webgpu_compute::GraphRunContext m_run_context;
    std::queue<webgpu_compute::GraphRunContext> m_pending_contexts;
